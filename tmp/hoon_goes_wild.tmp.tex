...
\kode{\%fork} is simply a union type.  A type is a set of nouns---
...
(\kode{=variable expression} is \emph{not} in any way Hoon syntax---any
...
The axis gets us to the \kode{\%dog} face; the name actually removes it.
So we can write
